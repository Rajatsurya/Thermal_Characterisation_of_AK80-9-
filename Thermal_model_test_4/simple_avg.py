...
df = pd.read_csv('test4_4amps_data_cleaned.csv')
...
# Save the result
df_cleaned.to_csv('test4_4amps_data_with_avg.csv', index=False)
print("Data saved to 'test4_4amps_data_with_avg.csv'")
